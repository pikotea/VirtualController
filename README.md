...
4. このツールの画面上部のコントローラーUIで、「BACK」ボタンを押して**2P側**の「CONTROLLER SETTINGS」を開きボタンを割り当ててください（**LT、RTボタンは使えないことに注意してください**）。
<img src="docs/images/setting_04_key.png" alt="ボタン設定" width="400">
※コントローラーUI通りに設定するとわかりやすいと思います
